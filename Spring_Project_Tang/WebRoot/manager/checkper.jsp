...
<!-- #EndLibraryItem --><table width="1002" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <p>
    				<a>共${pb.lastPage}页</a>
					<a href="checkper.do?pageNo=${pb.firstPage}&pageSize=${pb.pageSize}">首页</a>
    				<a href="checkper.do?pageNo=${pb.previousPage}&pageSize=${pb.pageSize}">上一页</a>
    				<a href="checkper.do?pageNo=${pb.nextPage}&pageSize=${pb.pageSize}">下一页</a>
    				<a href="checkper.do?pageNo=${pb.lastPage}&pageSize=${pb.pageSize}">尾页</a>
					<a>第${pb.pageNo }页</a> 
					<a>共${pb.count }条记录</a>
              <label>
