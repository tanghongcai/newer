...
<div id="left2">
      ...
      <p ><a href="loging.do" target="_self">退出系统</a></p>
	    ...
	    <spf:form id="form1" name="form1" modelAttribute="update"  method="post" action="updateUser.do">
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            ...
            <tr>
              ...
              <td>${emp.duty }</td>
              <td><label>
                <input type="radio" name="radiobutton" value="${emp.employeeId }" />
              </label></td>
            </tr>
            </c:forEach>
          </table>
	      <p>
	     			 <a>共${pb.lastPage}页</a>
					<a href="fuser.do?pageNo=${pb.firstPage}&pageSize=${pb.pageSize}">首页</a>
			    	<a href="fuser.do?pageNo=${pb.previousPage}&pageSize=${pb.pageSize}">上一页</a>
			    	<a href="fuser.do?pageNo=${pb.nextPage}&pageSize=${pb.pageSize}">下一页</a>
			    	<a href="fuser.do?pageNo=${pb.lastPage}&pageSize=${pb.pageSize}">尾页</a>
					<a>第${pb.pageNo }页</a> 
					<a>共${pb.count }条记录</a>
            <label>
            <input name="button" id="sub" type="submit" class="menu3" value="详情" />
            </label>
            <label></label>
	      </p>
        </spf:form>
