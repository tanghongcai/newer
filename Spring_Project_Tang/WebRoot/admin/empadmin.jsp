...
<div id="left2">
      ...
      <p ><a href="loging.do" target="_self">退出系统</a></p>
	    ...
	    <form id="form1" name="form1" modelAttribute="deleteUser" method="post" action="delete.do">
	      ...
	      <p>
	      			<a>共${pb.lastPage}页</a>
					<a href="select.do?pageNo=${pb.firstPage}&pageSize=${pb.pageSize}">首页</a>
			    	<a href="select.do?pageNo=${pb.previousPage}&pageSize=${pb.pageSize}">上一页</a>
			    	<a href="select.do?pageNo=${pb.nextPage}&pageSize=${pb.pageSize}">下一页</a>
			    	<a href="select.do?pageNo=${pb.lastPage}&pageSize=${pb.pageSize}">尾页</a>
					<a>第${pb.pageNo }页</a> 
					<a>共${pb.count }条记录</a>
            <label>
