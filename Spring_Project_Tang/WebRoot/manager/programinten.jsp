    ...
    <td class="rightimg"><!-- #BeginLibraryItem "/Library/left.lbi" --><div id="left">
      ...
      <p><a href="invalidate.do" target="_self">退出系统</a></p>
        ...
        <p>您现在的位置 &gt;&gt; 跟踪任务 &gt;&gt; 跟踪计划信息</p>
		 <form id="form1" name="form1" method="post" action="update.do?id=${mt.t.taskId}">
		<h1>任务详细信息:</h1>
          
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            <tr>
              <td width="15%" class="tdcolor">任务名称</td>
              <td width="579" colspan="3">${mt.t.taskName}</td>
            </tr>
            <tr>
              <td class="tdcolor">任务描述</td>
              <td colspan="3">&nbsp;${mt.t.taskDesc}</td>
            </tr>
            <tr>
              <td class="tdcolor">开始时间</td>
              <td width="579">${mt.t.beginDate}</td>
              <td width="579" class="tdcolor">结束时间</td>
              <td width="579"><p>&nbsp;${mt.t.endDate}</p></td>
            </tr>
            
            <tr>
              <td class="tdcolor">实施人</td>
              <td>&nbsp;${mt.t.implementorId.realName}</td>
