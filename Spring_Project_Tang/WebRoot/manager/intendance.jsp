  ...
  <tr>
    <td class="rightimg"><!-- #BeginLibraryItem "/Library/left.lbi" --><div id="left">
      ...
      <p><a href="invalidate.do" target="_self">退出系统</a></p>
        ...
        <h1>跟踪任务:</h1>
        <form id="form1" name="form1" method="post" action="prog.do">
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
            ...
            <tr>
              ...
              <td>${t.t.status}</td>
              <td><label>
                <input type="radio" name="radiobutton" value="${t.t.taskId}" />
              </label></td>
            </tr>
			</c:forEach>
    ...
    <p>
            <label>
            		<a>共${pb.lastPage}页</a>
					<a href="intendance.do?pageNo=${pb.firstPage}&pageSize=${pb.pageSize}">首页</a>
			    	<a href="intendance.do?pageNo=${pb.previousPage}&pageSize=${pb.pageSize}">上一页</a>
			    	<a href="intendance.do?pageNo=${pb.nextPage}&pageSize=${pb.pageSize}">下一页</a>
			    	<a href="intendance.do?pageNo=${pb.lastPage}&pageSize=${pb.pageSize}">尾页</a>
					<a>第${pb.pageNo }页</a> 
					<a>共${pb.count }条记录</a>
