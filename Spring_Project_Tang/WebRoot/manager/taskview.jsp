...
<!-- #EndLibraryItem --><table width="1002" border="0" cellspacing="0" cellpadding="0">
  <tr>
        ...
        <form action="taskparticular.do" method="post" name="form1" target="_self" id="form1">
          <table width="700" border="0" cellpadding="0" cellspacing="0" class="table">
			...
			<tr>
              ...
              <td><input type="radio" name="radiobutton" value="${t.t.taskId}" /></td>
			</tr>
			</c:forEach>
    ...
    <p>
    				<a>共${pb.lastPage}页</a>
					<a href="AllTask.do?pageNo=${pb.firstPage}&pageSize=${pb.pageSize}">首页</a>
			    	<a href="AllTask.do?pageNo=${pb.previousPage}&pageSize=${pb.pageSize}">上一页</a>
			    	<a href="AllTask.do?pageNo=${pb.nextPage}&pageSize=${pb.pageSize}">下一页</a>
			    	<a href="AllTask.do?pageNo=${pb.lastPage}&pageSize=${pb.pageSize}">尾页</a>
					<a>第${pb.pageNo }页</a> 
					<a>共${pb.count }条记录</a>
              <label>
